...
function StockEntries() {
  ...
  const [listStockEntries, setListStockEntries] = useState<StockEntry[]>([]);
  ...
  function handleNewEntry() {
    ...
    if (listStockEntries && listStockEntries.length > 0) {
